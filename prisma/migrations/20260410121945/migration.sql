/*
  ...
  - The values [APPROVED,BANNED,DISCONTINUE] on the enum `SessionStatus` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "SessionStatus_new" AS ENUM ('CREATED', 'FINISHED');
...
ALTER TABLE "TutorSession" ALTER COLUMN "status" SET DEFAULT 'CREATED';
COMMIT;
